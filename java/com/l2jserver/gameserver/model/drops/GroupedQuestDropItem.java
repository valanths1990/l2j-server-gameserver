...
/**
 * This group ignores deep blue drop calculations
 * @author Battlecruiser
 */
public class GroupedQuestDropItem extends GroupedGeneralDropItem
{
	
	/**
	 * @param chance
	 */
	public GroupedQuestDropItem(double chance)
	{
		super(chance);
	}
