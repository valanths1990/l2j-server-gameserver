...
public final class UseItem extends L2GameClientPacket {
	...
	@Override protected void runImpl() {
		...
		if (item.isEquipable()) {
			...
			if (((weaponItem != null) && (weaponItem.getItemType() == FISHINGROD)) && (((_itemId >= 6519) && (_itemId <= 6527)) || ((_itemId >= 7610) && (_itemId <= 7613)) || ((_itemId >= 7807) && (_itemId <= 7809)) || ((_itemId >= 8484) && (_itemId <= 8486)) || ((_itemId >= 8505) && (_itemId <= 8513)))) {
			...
			EventDispatcher.getInstance().notifyEventAsync(new OnItemUse((L2PcInstance) activeChar, item), Containers.Players());
