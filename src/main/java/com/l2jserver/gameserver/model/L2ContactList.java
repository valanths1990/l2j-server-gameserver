...
public class L2ContactList {
	...
	private static final Logger _log = Logger.getLogger(L2ContactList.class.getName());
	...
	public void restore() {
		...
		try (var con = ConnectionFactory.getInstance().getConnection();
			var ps = con.prepareStatement(QUERY_LOAD)) {
	...
	public boolean add(String name) {
		...
		try (var con = ConnectionFactory.getInstance().getConnection();
			var ps = con.prepareStatement(QUERY_ADD)) {
			ps.setInt(1, activeChar.getObjectId());
	...
	public void remove(String name) {
		...
		try (var con = ConnectionFactory.getInstance().getConnection();
			var ps = con.prepareStatement(QUERY_REMOVE)) {
			ps.setInt(1, activeChar.getObjectId());
			ps.setInt(2, contactId);
			ps.execute();
