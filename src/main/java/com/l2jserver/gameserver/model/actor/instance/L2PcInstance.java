...
public final class L2PcInstance extends L2Playable {
	 ...
	 * Bypass validations
	 */
	@SuppressWarnings("unchecked") private final LinkedList<String>[] _htmlActionCaches = new LinkedList[HtmlActionScope.values().length];
	...
	@Override public PcKnownList getKnownList() {
		return (PcKnownList) super.getKnownList();
	}

	@Override public void initKnownList() {
		setKnownList(new PcKnownList(this));
	}

	@Override public PcStat getStat() {
		return (PcStat) super.getStat();
	}

	@Override public void initCharStat() {
		setStat(new PcStat(this));
	}

	@Override public PcStatus getStatus() {
		return (PcStatus) super.getStatus();
	}

	@Override public void initCharStatus() {
	 ...
	 */
	@Override public L2PcTemplate getTemplate() {
	...
	@Override protected L2CharacterAI initAI() {
	...
	@Override public double getLevelMod() {
		if (isTransformed()) {
	 ...
	 */
	@Override public byte getSiegeState() {
		return _siegeState;
	}
	...
	@Override public int getSiegeSide() {
		return _siegeSide;
	}
	...
	@Override public byte getPvpFlag() {
		return _pvpFlag;
	}
	...
	@Override public void updatePvPFlag(int value) {
		if (getPvpFlag() == value) {
			return;
		}
		setPvpFlag(value);
	...
	@Override public void revalidateZone(boolean force) {
	...
	@Override public boolean addLevel(int value) {
	...
	@Override public void onLevelChange(boolean levelIncreased) {
		if (levelIncreased) {
	 ...
	 */
	@Override public PcInventory getInventory() {
		return _inventory;
	}
	 ...
	 * @return boolean informing if the action was successful
	 */
	@Override public boolean destroyItem(String process, int objectId, long count, L2Object reference, boolean sendMessage) {
	 ...
	 * @return boolean informing if the action was successful
	 */
	@Override public boolean destroyItemByItemId(String process, int itemId, long count, L2Object reference, boolean sendMessage) {
	...
	@Override public boolean isAlikeDead() {
	...
	@Override public void enableSkill(Skill skill) {
		super.enableSkill(skill);
		removeTimeStamp(skill);
	}

	@Override public boolean checkDoCastConditions(Skill skill) {
	...
	@Override public void broadcastPacket(L2GameServerPacket mov) {
	...
	@Override public void broadcastPacket(L2GameServerPacket mov, int radiusInKnownlist) {
		if (!(mov instanceof CharInfo)) {
			sendPacket(mov);
		}
	 ...
	 */
	@Override public void sendPacket(L2GameServerPacket packet) {
		if (_client != null) {
	 ...
	 */
	@Override public void sendPacket(SystemMessageId id) {
	 ...
	 */
	@Override public void doPickupItem(L2Object object) {
	...
	@Override public void doAttack(L2Character target) {
		super.doAttack(target);
		setRecentFakeDeath(false);
	}

	@Override public void doCast(Skill skill) {
	...
	@Override public boolean isTransformed() {
	...
	@Override public void untransform() {
		if (_transformation != null) {
			setQueuedSkill(null, false, false);
	...
	@Override public Transform getTransformation() {
	 ...
	 */
	@Override public void setTarget(L2Object newTarget) {
		if (newTarget != null) {
	 ...
	 */
	@Override public L2ItemInstance getActiveWeaponInstance() {
	 ...
	 */
	@Override public L2Weapon getActiveWeaponItem() {
	 ...
	 */
	@Override public L2ItemInstance getSecondaryWeaponInstance() {
	 ...
	 * Arrows, Shield..<BR>
	 */
	@Override public L2Item getSecondaryWeaponItem() {
	...
	@Override public void addExpAndSp(long addToExp, int addToSp) {
	...
	@Override public L2Summon getSummon() {
		return _summon;
	}
	 ...
	 */
	@Override public L2Clan getClan() {
		return _clan;
	}
	 ...
	 */
	@Override protected void reduceArrowCount(boolean bolts) {
	 ...
	 */
	@Override protected boolean checkAndEquipArrows() {
	 ...
	 */
	@Override protected boolean checkAndEquipBolts() {
		// Check if nothing is equiped in left hand
		if (getInventory().getPaperdollItem(Inventory.PAPERDOLL_LHAND) == null) {
			// Get the L2ItemInstance of the arrows needed for this bow
	 ...
	 */
	@Override public boolean isInvul() {
	 ...
	 */
	@Override public boolean isInParty() {
		return _party != null;
	}
	 ...
	 */
	@Override public L2Party getParty() {
		return _party;
	}
	 ...
	 */
	@Override public L2AccessLevel getAccessLevel() {
	...
	@Override public void storeMe() {
		store(true);
	}

	@Override public void storeEffect(boolean storeEffects) {
		if (!character().storeSkillCooltime()) {
			return;
		}
	...
	@Override public Skill addSkill(Skill newSkill) {
	...
	@Override public Skill removeSkill(Skill skill, boolean store) {
	 ...
	 */
	@Override public void restoreEffects() {
	 ...
	 * </ul>
	 */
	@Override public boolean isAutoAttackable(L2Character attacker) {
		if (attacker == null) {
			return false;
		}
	 ...
	 */
	@Override public boolean useMagic(Skill skill, boolean forceUse, boolean dontMove) {
	...
	private boolean checkUseMagicConditions(Skill skill, boolean forceUse, boolean dontMove) {
		...
		if (target.isDoor()) {
			...
			final L2DoorInstance door = (L2DoorInstance) target;
			 if ((door.getCastle() != null) && (door.getCastle().getResidenceId() > 0) && door.getInstanceId()==0) {
				if (!door.getCastle().getSiege().isInProgress()) {
					sendPacket(SystemMessageId.INCORRECT_TARGET);
					return false;
				}
			} else if ((door.getFort() != null) && (door.getFort().getResidenceId() > 0) && door.getInstanceId()==0) {
	...
	@Override public void stopAllEffects() {
		super.stopAllEffects();
		updateAndBroadcastStatus(2);
	}

	@Override public void stopAllEffectsExceptThoseThatLastThroughDeath() {
	...
	@Override public void rechargeShots(boolean physical, boolean magic) {
		L2ItemInstance item;
	...
	@Override public int getPledgeType() {
		return _pledgeType;
	}
	...
	@Override public boolean isInDuel() {
		return _duelState != DuelState.NO_DUEL;
	}

	@Override public int getDuelId() {
		return _duelId;
	}
	...
	@Override public boolean isAcademyMember() {
	...
	@Override public void doRevive(double revivePower) {
		doRevive();
	...
	@Override public void teleToLocation(ILocational loc, boolean allowRandomOffset) {
	...
	@Override public void onTeleported() {
		super.onTeleported();
	...
	@Override public void setIsTeleporting(boolean teleport) {
	...
	@Override public void reduceCurrentHp(double value, L2Character attacker, boolean awake, boolean isDOT, Skill skill) {
		if (skill != null) {
	 ...
	 * </ul>
	 */
	@Override public boolean deleteMe() {
		cleanup();
		storeMe();
	...
	@Override public L2PcInstance getActingPlayer() {
		return this;
	}

	@Override public int getMaxLoad() {
		return (int) calcStat(Stats.WEIGHT_LIMIT, Math.floor(BaseStats.CON.calcBonus(this) * 69000 * character().getWeightLimit()), this, null);
	}

	@Override public int getBonusWeightPenalty() {
		return (int) calcStat(Stats.WEIGHT_PENALTY, 1, this, null);
	}

	@Override public int getCurrentLoad() {
		return getInventory().getTotalWeight();
	}

	@Override public void sendDamageMessage(L2Character target, int damage, boolean mcrit, boolean pcrit, boolean miss) {
	...
	@Override public void sendInfo(L2PcInstance activeChar) {
		if (isInBoat()) {
	...
	@Override public boolean isMovementDisabled() {
	...
	@Override public boolean isChargedShot(ShotType type) {
		final L2ItemInstance weapon = getActiveWeaponInstance();
		return (weapon != null) && weapon.isChargedShot(type);
	}

	@Override public void setChargedShot(ShotType type, boolean charged) {
		final L2ItemInstance weapon = getActiveWeaponInstance();
		if (weapon != null) {
	 ...
	 */
	@Override public boolean canRevive() {
	 ...
	 * @param val
	 */
	@Override public void setCanRevive(boolean val) {
		_canRevive = val;
	}
	 ...
	 */
	@Override public boolean isOnEvent() {
		for (IEventListener listener : _eventListeners) {
	...
	@Override public void addOverrideCond(PcCondOverride... excs) {
		super.addOverrideCond(excs);
		getVariables().set(COND_OVERRIDE_KEY, Long.toString(_exceptions));
	}

	@Override public void removeOverridedCond(PcCondOverride... excs) {
