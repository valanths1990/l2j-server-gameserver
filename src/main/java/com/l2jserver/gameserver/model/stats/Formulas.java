...
import static com.l2jserver.gameserver.config.Configuration.balance;
...
//        if (isPvP && !((L2PcInstance) attacker).isInOlympiadMode()) {
//            L2PcInstance pc = attacker.getActingPlayer();
//            damage *= balance().getPvpBlowDamageMultipliers().get(pc.getClassId().getId());
//        }
...
//            damage *= balance().getPvpBackStabDamageMultipliers().get(pc.getClassId().getId());
//        }
...
//            if(!target.getActingPlayer().isInOlympiadMode()){
//                defence*= balance().getPvpPhysicalAttackDefenceMultipliers().get(target.getActingPlayer().getClassId().getId());
//            }
        }
...
//        if (isPvP && !((L2PcInstance) attacker).isInOlympiadMode()) {
//            L2PcInstance pc = attacker.getActingPlayer();
//            damage *= balance().getPvpPhysicalAttackDamageMultipliers().get(pc.getClassId().getId());
//        }
        return Math.max(damage, 1);
    }
...
//                pvpBonus = balance().getPvpPhysicalSkillDamageMultipliers().get(attacker.getActingPlayer().getClassId().getId());
//            }
            // Defense bonuses in PvP fight
            defence *= target.getStat().calcStat(Stats.PVP_PHYS_SKILL_DEF, 1.0);
//            if (!target.getActingPlayer().isInOlympiadMode()) {
//                defence *= balance().getPvpPhysicalSkillDefenceMultipliers().get(target.getActingPlayer().getClassId().getId());
//            }
        }
...
//        if (isPvP && !((L2PcInstance) attacker).isInOlympiadMode()) {
//            L2PcInstance pc = attacker.getActingPlayer();
//            damage *= balance().getPvpPhysicalSkillDamageMultipliers().get(pc.getClassId().getId());
//        }
        return Math.max(damage, 1);
    }
...
//            L2PcInstance pc = attacker.getActingPlayer();
//            damage *= balance().getPvpMagicalDamageMultipliers().get(pc.getClassId().getId());
//        }
        return damage;
    }
